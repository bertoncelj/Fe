function p = poloznica(vpis_energija, vpis_mesec)
...
%RACUNANJE-----------------------------------------------------------
  ...
  energyVT = ceil(energy*(1/3));
  energyMT = ceil(energy*(2/3));
...
%IZPIS-------------------------------------------------------------------------
 printf("%sRACUN EE:\n\tenergija:%d \n\tobracun_moc: %d \n\tmeseci: %d \n%s\n",MAGENTA, vpis_energy,vpis_obracunska_moc, vpis_meseci, RESET);
